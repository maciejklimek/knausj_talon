...
class Actions:
    ...
    def mouse_scroll_up_continuous(speed_factor: Optional[int] = None):
        ...
        print(f"[DEBUG] mouse_scroll_up_continuous called, speed_factor={speed_factor}")
        mouse_scroll_continuous(-1, speed_factor)

    def mouse_scroll_down_continuous(speed_factor: Optional[int] = None):
        """Scrolls down continuously"""
        print(f"[DEBUG] mouse_scroll_down_continuous called, speed_factor={speed_factor}")
        mouse_scroll_continuous(1, speed_factor)

    def mouse_scroll_right_continuous(speed_factor: Optional[int] = None):
        """Scrolls right continuously"""
        print(f"[DEBUG] mouse_scroll_right_continuous called, speed_factor={speed_factor}")
    ...
    def mouse_scroll_left_continuous(speed_factor: Optional[int] = None):
        ...
        print(f"[DEBUG] mouse_scroll_left_continuous called, speed_factor={speed_factor}")
        mouse_scroll_continuous(-1, speed_factor, is_vertical=False)
...
def mouse_scroll_continuous(
    ...
    # Debug information
    print(f"Function: mouse_scroll_continuous")
    print(f"Continuous scroll: dir={new_scroll_dir}, speed={speed_factor}, vertical={is_vertical}")
    print(f"Current mode: {continuous_scroll_mode}")
    print(f"Scroll job active: {scroll_job is not None}")
    print(f"Scroll start time: {scroll_start_ts}")
...
def scroll_continuous_helper():
    ...
    print(f"[DEBUG] scroll_continuous_helper: scroll_delta={scroll_delta}, acceleration={acceleration_speed:.2f}, acceleration_setting={acceleration_setting}")
    if scroll_delta == 0:
